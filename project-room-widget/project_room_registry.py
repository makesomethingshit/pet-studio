...
spec = importlib.util.spec_from_file_location("_pet_studio_project_room_registry", target)
if spec is None or spec.loader is None:
    raise ImportError(f"Could not load Pet Studio registry module: {target}")
