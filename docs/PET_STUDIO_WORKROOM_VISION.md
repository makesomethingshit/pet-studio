...
Pet Studio는 **비전공자를 위한 오픈소스 AI 팀 운영 도구**입니다. 복잡한 설정 없이 미션을 입력하면, 역할에 맞는 AI가 알아서 일하고, 결과를 하나의 창에서 확인할 수 있습니다. 자신의 API 키로 연결해서 쓰는 로컬 앱입니다.

**"Pet"은 애완동물이 아니라 내 AI팀을 뜻합니다.** 내가 키우고, 내가 돌보고, 내가 미션을 주면 알아서 일하는 — 그런 팀.

**포지셔닝:** 기능은 남들 뒤에서 따라가되, 사용감은 압도적으로 앞선다. 기술 리더가 아니라 사용성 리더.
...
- 자신의 API 키를 연결해서 무료로 AI를 쓰고 싶은 사람
