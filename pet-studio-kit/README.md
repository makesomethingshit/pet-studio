...
```powershell
python `
  pet-studio-kit\scripts\create_project_room_kit.py `
...
```powershell
python `
  pet-studio-kit\scripts\register_pet_package.py `
  --kit-dir pet-studio-kit\kit `
...
```powershell
python `
  pet-studio-kit\scripts\run_full_experiment.py `
  --source-kit-dir pet-studio-kit\kit `
...
```powershell
python `
  pet-studio-kit\scripts\create_sample_assets.py `
  --kit-dir pet-studio-kit\kit
```
...
```powershell
python `
  pet-studio-kit\scripts\validate_project_room_kit.py `
  --kit pet-studio-kit\kit\project-room.json `
  --json-out runs\pet-studio-kit-sample\kit-style-validation.json
```

```powershell
python `
  pet-studio-kit\scripts\bake_project_room_pet.py `
  --kit pet-studio-kit\kit\project-room.json `
  --out-dir runs\pet-studio-kit-sample `
  --pet-id pet-studio-kit-sample `
...
python `
  ...
  runs\pet-studio-kit-sample\spritesheet.webp `
  --json-out runs\pet-studio-kit-sample\validation.json
```
...
python `
  ...
  runs\pet-studio-kit-sample\spritesheet.webp `
  --output runs\pet-studio-kit-sample\contact-sheet.png
```
