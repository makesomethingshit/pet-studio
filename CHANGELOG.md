...
- Added Codex event bridge commands plus a local installer for notify and `hooks.json` lifecycle integration that updates widget bubble state from Codex task activity.
